...
const variants = cva({
	...
	compoundVariants: [
		...
		{
			className: 'focus-visible:ring-foreground-500/70',
			mode: 'ring',
			strength: 'default',
			variant: 'default',
		},
		{
			className: 'focus-visible:ring-primary-500/70',
			mode: 'ring',
			strength: 'default',
			variant: 'primary',
		},
		{
			className: 'focus-visible:ring-success-500/70',
			mode: 'ring',
			strength: 'default',
			variant: 'success',
		},
		{
			className: 'focus-visible:ring-error-500/70',
			mode: 'ring',
			strength: 'default',
			variant: 'danger',
		},
		{
			className: 'focus-visible:ring-foreground-500/40',
			mode: 'ring',
			strength: 'soft',
			variant: 'default',
		},
		{
			className: 'focus-visible:ring-primary-500/40',
			mode: 'ring',
			strength: 'soft',
			variant: 'primary',
		},
		{
			className: 'focus-visible:ring-success-500/40',
			mode: 'ring',
			strength: 'soft',
			variant: 'success',
		},
		{
			className: 'focus-visible:ring-error-500/40',
			mode: 'ring',
			strength: 'soft',
			variant: 'danger',
		},
